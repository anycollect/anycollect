...
public abstract class TestMeterRegistry extends MeterRegistry {
    @Nonnull
    @Override
    ...
    @Nonnull
    @Override
    public <T> FunctionCounter counter(@Nonnull final MeterId id, @Nonnull final T obj, @Nonnull final ToLongFunction<T> value) {
